...
const Topmost2 = ({
  ...
  return (
    <header className="self-stretch flex flex-row items-start justify-center pt-[1.187rem] px-[1.25rem] pb-[1.112rem] box-border sticky gap-[11rem] top-[0] z-[99] max-w-full text-left text-[2.25rem] text-primary font-display-2 mq450:gap-[1.375rem] mq1100:gap-[5.5rem] mq750:gap-[2.75rem]">
      <div className="h-full w-full absolute !m-[0] top-[0rem] right-[0rem] bottom-[0rem] left-[0rem] bg-white" />
      <h1
        className="m-0 h-[2.625rem] relative text-inherit uppercase font-normal font-inherit inline-block whitespace-nowrap cursor-pointer z-[1]"
      ...
      <div className="w-[38.938rem] flex flex-col items-start justify-start pt-[0.062rem] px-[0rem] pb-[0rem] box-border max-w-full text-[1rem] font-body">
        <div className="self-stretch flex flex-row items-start justify-start gap-[1.25rem] z-[1]">
          <div className="flex flex-row items-end justify-start gap-[0.343rem]">
            <img
              className="h-[2.388rem] w-[2.513rem] relative"
              loading="lazy"
              alt=""
              src="/group-188.svg"
            />
            <div className="flex flex-col items-start justify-end pt-[0rem] px-[0rem] pb-[0.137rem]">
              <div className="flex flex-col items-start justify-start gap-[0.125rem] mq1025:hidden">
          ...
          <div className="flex-1 flex flex-col items-start justify-start pt-[0.062rem] px-[0rem] pb-[0rem]">
            <div className="self-stretch flex flex-row items-start justify-start gap-[0.606rem]">
              <div className="flex flex-col items-start justify-start pt-[0.25rem] px-[0rem] pb-[0rem]">
                <input
                  className="border-white accent-white cursor-pointer m-0 w-[1.875rem] h-[1.875rem] relative"
                  checked={true}
                  type="radio"
          ...
          <div className="flex flex-col items-start justify-start pt-[0.062rem] px-[0rem] pb-[0rem]">
            <div className="flex flex-row items-start justify-start gap-[0.6rem]">
              ...
              <div className="flex flex-col items-start justify-start gap-[0.125rem] mq450:hidden">
                <div className="relative uppercase font-medium inline-block min-w-[5rem]">
                  Location
                </div>
                <div className="relative font-medium text-secondary whitespace-nowrap">
                  Old Town, Bhubanweswar
                </div>
              </div>
            </div>
          </div>
