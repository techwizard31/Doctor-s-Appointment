const GroupComponent2 = () => {
  return (
    <div className="flex-[0.9351] flex flex-row items-start justify-start pt-[2.212rem] px-[1.875rem] pb-[3.025rem] box-border relative min-w-[11.563rem] max-w-[14.563rem] text-left text-[1rem] text-lightsteelblue-100 font-body mq450:flex-1">
