const GroupComponent1 = () => {
  return (
    <div className="flex-[0.9784] flex flex-row items-start justify-start pt-[3.562rem] pb-[3.5rem] pr-[1.375rem] pl-[1.875rem] box-border relative min-w-[11.563rem] max-w-[14.563rem] text-left text-[1.125rem] text-primary font-body mq450:flex-1">
